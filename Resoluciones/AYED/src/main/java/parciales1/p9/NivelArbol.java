                    ...
                    if(actual != null){
                        if(nivel == n){
                            ...
                            if(actual.hasLeftChild()){
                                if(actual.getLeftChild().isLeaf()){
                                    if(actual.getLeftChild().getData() < min){
                                        min = actual.getLeftChild().getData();
                                    }
                                }
                            }
                            if(actual.hasRightChild()){
                                if(actual.getRightChild().isLeaf()){
                                    if(actual.getRightChild().getData() < min){
                                        min =  actual.getRightChild().getData();
                                    }
                                }
                            }
                        }
